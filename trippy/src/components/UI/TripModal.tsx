      ...
      <div className="relative bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center">
              ...
              <div className="w-1.5 h-16 bg-slate-100 rounded-full relative overflow-hidden my-1">
                {/* The "Liquid" Fill - Represents trip completion */}
            ...
            <div className="flex flex-col justify-between py-0.5">
              ...
              <div>
                ...
                <p className="font-extrabold text-gray-800">{trip.endPoint}</p>
              </div>
            </div>
          </div>

          {/* Trip Stats Grid - 2x2 Layout */}
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Row 2: Audit Trail (Modified Time) */}
            <div className="col-span-2 bg-slate-50/50 p-3 rounded-xl border border-dashed border-gray-200 flex items-center justify-between">
              ...
              {/* Status indicator to show it's synced/updated */}
